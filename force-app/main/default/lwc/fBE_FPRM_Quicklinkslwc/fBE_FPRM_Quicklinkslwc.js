...
export default class FBE_FPRM_Quicklinkslwc extends NavigationMixin (LightningElement) {
    title = "Quick Links";
    showFeatures =true;
  ...
  @api PartnerProgramlink ='https://www.delltechnologies.com/partner/en-us/partner/partner.htm';
    ...
    wireuser({error,data}) {
       ...
       navigateToDealRegistrationPage() {
        console.log("navigateToDealRegistrationPage");
