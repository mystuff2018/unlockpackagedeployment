({
	doinit : function(component, event, helper) {
        ...
        var action =component.get('c.returnAccMember');
        var TeamMemArray=[];
        var title="Account Team";
        action.setParams({
            LeadId : leadrecId
        });
      ...
      handleClick: function(component, event, helper) {
        var parentId= component.get("v.simpleRecord.FBE_Account_Name__c");
        ...
        var LeadId = component.get("v.simpleRecord.Id");
         ...
         var pageReference = {
            ...
            "attributes": {
                "componentName": 'c__FBE_AccTeamListPage',
